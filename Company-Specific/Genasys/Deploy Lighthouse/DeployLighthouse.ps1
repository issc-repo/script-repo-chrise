...
New-AzDeployment -Name LightHouse -Location westeurope -TemplateFile "C:\Genasys\rgDelegatedResourceManagement.json" -TemplateParameterFile "C:\Genasys\rgDelegatedResourceManagement.parameters.json" -Verbose
