...
$WsusUpstreamServer = "enablesrv.enable.local"
$UseSSL = $false
$PortNumber = 8530
$TrialRun = $false

#E-mail Configuration
#$SMTPServer = "mail.enable.co.za"
#$FromAddress = "jaco@enable.co.za"
#$Recipients = "jakes@enable.co.za"
#$MessageSubject = "ENABLESRV - WSUS Server Cleanup."
